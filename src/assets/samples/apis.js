...
export const ADD_ACCOMMODATION_TO_FAVOURITES_API = `${BASE_API}favourites`;
export const REMOVE_ACCOMMODATION_FROM_FAVOURITES_API = favId => `${BASE_API}favourites/${favId}`;
